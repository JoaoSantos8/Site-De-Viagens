...
function pacotes()
{
  ...
  ?>
    <form action="" method="GET" class="mt-4 w-25 float-right" id="pesquisaH">
      <div class="input-group">
    ...
    <div class="w-100" id="caixaPacotes">
      <?php while ($dados = mysqli_fetch_array($result)) {
        $sql = "SELECT * FROM destinos WHERE destinoId = {$dados['viagemDestinoId']}";
        $resultado = mysqli_query($con, $sql);
        $dadosD = mysqli_fetch_array($resultado);
        ...
        ?>
          ...
          <div id="caixaPacote" class=" m-5" style="height:730px;">
          <a href="pacote.php?id=<?php echo $dados['pacoteId'] ?>" style="color:black;">
        
              <h2 class="text-center p-4" style="color:white;">
                <?php echo $dados['pacoteNome'] ?>
              </h2>

              <div id="imgPacote">
                <div id="imagemPC">
                  <div id="descHT" class="text-center">Hotel&nbsp;
                    <?php echo $dados['hotelNome'] ?>
                  </div>
                  <img src="admin/<?php echo $dados['hotelImagemURL'] ?>"
                    style="border-radius:10px; width:800px; height:450px;">
                  <div id="descH">
              ...
              <div id="caixaDir" class="float-right">

                <div class="text-center p-2" id="destinosChe">

                  <h3 class="float-left" style="color:white; padding-left: 100px;">De
                    <?php echo $dadosD['destinoNome'] ?>
                  </h3>
                  <h3 class="float-right" style="color:white; padding-right:100px;">Para
                    <?php echo $chegadas['destinoNome'] ?>
                  </h3>

                </div>

                <div class="text-center" id="dataP">
                  <?php echo date('d/m/Y', strtotime($dados['viagemData'])); ?>
                </div>

                <div class="text-center" id="dataP">
                  Preço da Viagem <?php echo $dados['viagemPreco']; ?>€
                </div>

                <div class="text-center w-100 p-2" style="height: 50px;">

                  <div class="float-left" style="padding-left: 150px; color:white;">Partida</div>
                  <div class="float-right" style="padding-right: 150px; color:white;">Chegada</div>

                </div>

                <div class="text-center w-10 pl-3" style="height: 50px; border-bottom: solid 3px white;">

                  <div class="float-left" style="padding-left: 148px; color:black;">
                    <?php echo date('H:i', strtotime($dados['viagemChegada'])); ?>
                  </div>
                  <div class="float-right" style="padding-right: 180px; color:black;">
                    <?php echo date('H:i', strtotime($dados['viagemIni'])); ?>
                  </div>

                </div>

                <div class="text-center p-1" style="border-bottom: solid 3px white; color:white;">
                  <h3>Hotel
                    <?php echo $dados['hotelNome'] ?>
                  </h3>
                </div>
                ...
                <div class="w-100 text-center"
                  style="height:50px; background-color: rgb(11, 11, 114); color: white; border-bottom: solid 3px white;">
                  <div class="w-25 float-left">
                    <?php echo $dados['viagemPreco'] + $dados['hotelPreco'] ?>€
                  </div>
                  <div class="w-25 float-left" style="margin-left:70px">
                    <?php echo $dados['hotelPreco'] * 5 + $dados['viagemPreco'] ?>€
                  </div>
                  <div class="w-25 float-right">
                    <?php echo $dados['hotelPreco'] * 7 + $dados['viagemPreco'] ?>€
                  </div>
                </div>
                ...
                <div class="w-100 p-2">
                  ...
                  <div class="float-right mr-5">Tel:
                    <?php echo $dados['hotelTelefone'] ?>
                  </div>

                </div>
    <?php
    botao($dados['pacoteId'], $dados['pacoteNome'], $dados['viagemPreco'] + $dados['hotelPreco']);
    ?>
              </div>
