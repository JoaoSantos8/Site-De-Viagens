...
if(isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK){
    $upload_dir = 'images/eventos/'; // Altere isso para a pasta de destino
...
$sql="select * from eventos where eventoNome='$evento'";
$result=mysqli_query($con,$sql);
$dados=mysqli_fetch_array($result);


$evento=$dados["eventoId"];

//echo $descricao;
$sql="Insert into atividades values(0,'$nome','$urlImagem','$preco','$evento')";
//echo $sql;
//echo var_dump($_FILES['image']['name']);
mysqli_query($con,$sql);
header("location:listaAtividades.php");