...
if(isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK){
    $upload_dir = 'images/atividades/'; // Altere isso para a pasta de destino
...
//echo $descricao;
$sql="Insert into eventos values(0,'$nome','$urlImagem','$descricao','$email','$dataC','$dataA','$preco','$tipo','$destino')";
//echo $sql;
