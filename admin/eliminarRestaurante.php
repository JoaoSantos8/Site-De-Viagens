...
<div class="w-75 p-5 m-5">
        ...
        <form class="p-5 mt-5" action="confirmarEliminarRestaurante.php" method="post" enctype="multipart/form-data" id="formulario">
            <div class="mb-3">
                <label for="nomeDestino" class="form-label labelNome">NOME</label>
                <input type="text" disabled class="form-control" id="inputNome" name="nome" value="<?php echo $dados['restauranteNome'] ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="tel" disabled class="form-control" id="inputTel" name="telefone"  value="<?php echo $dados['restauranteTelefone'] ?>">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">PREÇO</label>
                <input type="number" disabled class="form-control" id="inputPreco" name="preco" placeholder="Preço por Pessoa"  value="<?php echo $dados['restaurantePreco'] ?>">
            </div>


            <div id="image">
                <label id="">RESTAURANTE - IMAGEM</label><br>
                <input disabled type="file" class="mb-3" name="image" id="img" onchange="verificar()"  value="<?php echo $dados['restauranteImagemURL'] ?>"><br>
            ...
            ?>
                ...
                <?php 
                    while ($dadosC = mysqli_fetch_array($resultado)) {
                        ...
                        echo '<option  disabled ' . $selected . '>' . $dadosC['concelhoNome'] . '</option>';
                    }?>
                        </select>
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="submit" class="btn btn-danger p-3" id="" value="ELIMINAR">
            </div>
        </form>
    </div>
