...
if(isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK){
    $upload_dir = 'images/restaurantes/'; // Altere isso para a pasta de destino
...
$sql="Insert into restaurantes values(0,'$nome','$urlImagem','$descricao','$telefone','$preco','$destino')";
//echo $sql;
