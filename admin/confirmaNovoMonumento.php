...
if(isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK){
    $upload_dir = 'images/monumentos/'; // Altere isso para a pasta de destino
...
$sql="Insert into monumentos values(0,'$nome','$urlImagem','$descricao','$email','$telefone','$preco','$destino')";
//echo $sql;
