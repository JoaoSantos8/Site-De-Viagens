...
if(isset($_FILES['image']) && $_FILES['image']['name'] != ''){
    $upload_dir = 'images/monumentos/'; // change this to the destination folder
...
$destino=$dados['concelhoId'];
        ...
        //$i++;
        $sql="Update monumentos set monumentoNome='$nome', monumentoImagemURL='$urlImagem', monumentoDescricao='$descricao', monumentoEmail='$email',monumentoTelefone='$tel',monumentoPreco='$preco', monumentoConcelhoId='$destino' where monumentoId='$id'";
        //echo $sql;
