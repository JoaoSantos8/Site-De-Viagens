...
if(isset($_FILES['image']) && $_FILES['image']['name'] != ''){
    $upload_dir = 'images/hoteis/'; // change this to the destination folder
...
$destino=$dados['concelhoId'];
        ...
        //$i++;
        $sql="Update hoteis set hotelNome='$nome', hotelImagemURL='$urlImagem', hotelDescricao='$descricao',hotelEmail='$email',hotelTelefone='$tel',hotelPreco='$preco', hotelConcelhoId='$destino' where hotelId='$id'";
        //echo $sql;
