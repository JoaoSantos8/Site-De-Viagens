...
<div class="w-75 p-5 m-5">
    <h1>Editar Hotel</h1>
    <form class="p-5 mt-5" action="confirmarEditarEvento.php" method="post" enctype="multipart/form-data"
        id="formulario">
        <div class="mb-3 p-3">
        ...
        <div class="mb-3 p-3">
            ...
            <textarea class="form-control" id="inputDesc"
                name="descricao"><?php echo $dados['eventoDescricao'] ?></textarea>
        </div>
        <div class="mb-3 p-3">
            <label for="email" class="form-label">EMAIL</label>
            <input type="email" class="form-control" id="inputEmail" name="email"
                value="<?php echo $dados['eventoEmail'] ?>">
        </div>
        <div class="mb-3 w-50 float-left p-3">
            <label for="data" class="form-label">DATA - COMEÇO</label>
            <input type="date" class="form-control" id="inputDataC" name="dataC" value="<?php echo $dados['eventoDataC'] ?>">
        </div>
        <div class="mb-3 w-50 float-right p-3">
            <label for="data" class="form-label">DATA - TERMINA</label>
            <input type="date" class="form-control" id="inputDataA" name="dataA" value="<?php echo $dados['eventoDataA'] ?>">
        </div>
        <div class="mb-3 p-3">
            <label for="email" class="form-label">PREÇO - POR NOITE</label>
            <input type="number" class="form-control w-25" id="inputPreco" name="preco"
                value="<?php echo $dados['eventoPreco'] ?>">
        </div>

        <div id="image" class="p-3">
            <label id="">EVENTO - IMAGEM</label><br>
            <input type="file" class="mb-3" name="imagem" id="img" onchange="verificar()"
    ...
    <select name="tipo" id="slect" class="p-3 mb-5 mt-2 w-25">
        ...
        <label class="mb-5 p-3"> LOCALIZAÇÃO <br></label>
            <select name="destino" id="slect" class="p-3 mb-5 mt-2 w-25">
                <?php
            ...
            <div class="mb-3 p-3">
                ...
                <input type="button" class="btn btn-primary p-3" id="confirmaEve" value="CONFIRMAR">
            </div>
    </form>
</div>
